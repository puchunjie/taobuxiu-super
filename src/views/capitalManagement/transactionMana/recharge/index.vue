      ...
      <div class="card-contnet">
        ...
        <div class="table-contnet">
          <Row class-name="head">
            ...
            <Col class-name="col" span="3">充值方式</Col>
            <Col class-name="col" span="4">充值流水号</Col>
            <Col class-name="col" span="3">附件</Col>
            <Col class-name="col" span="4">充值金额</Col>
            <Col class-name="col" span="3">审核人</Col>
            <Col class-name="col" span="3">充值时间</Col>
          </Row>
          <Row v-for="(item,index) in list" :key="index">
            <Col class-name="col" span="4">{{item.buserName}}</Col>
            <Col class-name="col" span="3">{{item.rechargeWay | rechargeWay}}</Col>
            <Col class-name="col" span="4">{{item.tradeNo}}</Col>
            ...
            <Col class-name="col" span="3">{{item.payTime | dateformat}}</Col>
          </Row>
...
<script>
  export default {
    ...
    methods: {
      getList(params) {
        this.$http.post(this.api.rechargeHistory, params).then(res => {
          if (res.code === 1000) {
