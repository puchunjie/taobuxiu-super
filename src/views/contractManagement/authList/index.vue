            ...
            <div class="card-contnet">
                <div class="table-contnet">
                    ...
                    <Row v-for="item in list" :key="item.contractId">
                        ...
                        <a target="_black" :href="'http://120.55.63.70:8080/contract.jsp?appUserId=100000000000000000000000000000001&loginId=' + getloginId + '&contractId=' + item.contractId + '&authorization=' + getToken" class="ivu-btn ivu-btn-primary ivu-btn-small">查看</a>
                        <Button type="primary" size="small" @click="contractInfo(item)">合同信息</Button>
                        <a target="_black" :href="'http://120.55.63.70:8080/contract_download_sys.jsp?loginId=' + getloginId + '&contractId=' + item.contractId + '&authorization=' + getToken" class="ivu-btn ivu-btn-primary ivu-btn-small" v-show="item.status == '1'">下载合同</a>
                        </Col>
                    </Row>
