...
export default {
  ...
  methods: {
    ...
    getList() {
      this.$http.post(this.api.storequaliticationtypePage,this.apiData).then(res =>{
        if(res.code === 1000){
    ...
    handleSubmit() {
      this.$refs[this.ref].validate((valid) => {
          if(valid){
              ...
              let apiUrl = this.isEdit ? this.api.updateStoreQualiticationType : this.api.saveStoreQualiticationType;
    ...
    deleteItem(item) {
        this.$Modal.confirm({
            ...
            onOk: () =>{
              ...
              this.$http.post(this.api.deleteStoreQualiticationType, params).then(res => {
                  if(res.code === 1000){
                      this.getList();
